...
import { NFTCONTRACT, STAKINGCONTRACT, bscscanapi, moralisapi, nftpng } from './config';
...
const Web3Alc = createAlchemyWeb3("https://speedy-nodes-nyc.moralis.io/36e16d2ef26dda90a067fe0e/bsc/mainnet");

const moralisapikey = "SnWPtJstmawYFiA482TUr2J2lxkJ2rEbPXnhQu7XWWJgjL3kDkpBkkxbdJwyEkLa";
const bscscanapikey = "Z4G9E2M8MBMUN9P4VJB6I27ISY929ZY5K1";
...
const providerOptions = {
  ...
  walletlink: {
    package: WalletLink,
    options: {
      appName: "Hybrids Staking Dapp",
      infuraId: "",
      rpc: "https://speedy-nodes-nyc.moralis.io/36e16d2ef26dda90a067fe0e/bsc/mainnet",
      chainId: 56,
      appLogoUrl: null,
      darkMode: true
    }
    ...
    return (
      <div className="App nftapp">
            ...
            <body className='nftminter'>
              <form>
                <div className="row pt-3">
                  <div>
                    <h1 className="pt-2" style={{ fontWeight: "30" }}>APS MINTER</h1>
                  </div>
                  <h3>{balance.result}/5555</h3>
                ...
                <h6 className="pt-2" style={{ fontFamily: "SF Pro Display", fontWeight: "300", fontSize: "18px" }}>Do not mint using this portal!</h6>
                <div className="row px-2 pb-2 row-style">
                  <div className="col ">
                    <Button className="button-style" style={{ border: "0.2px", borderRadius: "14px", boxShadow: "1px 1px 5px #000000" }}>
                      <img src="n2dr-logo.png" width="70%" />
                    </Button>
                  </div>
                  <div>
          ...
          <div className='col'>
            <body className='nftstaker border-0'>
              <form style={{ fontFamily: "SF Pro Display" }} >
                <h2 style={{ borderRadius: '14px', fontWeight: "300", fontSize: "25px" }}>Ape Hybrids Society Staking Vault </h2>
                ...
                <div className="row px-3">
                  <div className="col">
                    <form class="stakingrewards" style={{ borderRadius: "25px", boxShadow: "1px 1px 15px #ffffff" }}>
                      ...
                      <table className='table mt-3 mb-5 px-3 table-dark'>
                        <tr>
                          <td style={{ fontSize: "19px" }}>Your Staked APS:
                        ...
                        <tr>
                          <td style={{ fontSize: "19px" }}>Total Staked APS:
                        ...
                        <tr>
                          <td style={{ fontSize: "19px" }}>Unstake All Staked APS
                  ...
                  <div className="col">
                    <form className='stakingrewards' style={{ borderRadius: "25px", boxShadow: "1px 1px 15px #ffffff", fontFamily: "SF Pro Display" }}>
                      ...
                      <Button onClick={rewardinfo} style={{ backgroundColor: "#ffffff10", boxShadow: "1px 1px 5px #000000" }} >Earned HBDX Rewards</Button>
                ...
                <div className="row px-4 pt-2">
                  <div class="header">
                    <div style={{ fontSize: '25px', borderRadius: '14px', color: "#ffffff", fontWeight: "300" }}>HBDX APS Staking Pool Active Rewards</div>
                    <table className='table px-3 table-bordered table-dark'>
                      ...
                      <tbody>
                        <tr className='stakegoldeffect'>
                          <td>Ape Hybrids Society</td>
                          <td class="amount" data-test-id="rewards-summary-ads">
                            <span class="amount">1</span>&nbsp;<span class="currency">HBDX</span>
                          </td>
                          <td class="exchange">
                            <span class="amount">1</span>&nbsp;<span class="currency">APS/day</span>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <div class="header">
                      <div style={{ fontSize: '25px', borderRadius: '14px', fontWeight: '300' }}>HBDX Token Stake Farms</div>
                      <table className='table table-bordered table-dark' style={{ borderRadius: '14px' }} >
                        ...
                        <tbody>
                          <tr>
                            <td>Stake HBDX to Earn HBDX</td>
                            <td class="amount" data-test-id="rewards-summary-ads">
                              <span class="amount">0.01</span>&nbsp;<span class="currency">Per HBDX</span>
                            </td>
                          </tr>
                        </tbody>
                      </table>
        ...
        <div className='row nftportal mt-3'>
          ...
          <div className='col'>
            <h1 className='n2dtitlestyle mt-3'>Your APS Staking Portal</h1>
            <Button onClick={refreshPage} style={{ backgroundColor: "#000000", boxShadow: "1px 1px 5px #000000" }}>Refresh APS Portal</Button>
          </div>
